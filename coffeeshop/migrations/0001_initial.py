    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img_product', models.CharField(max_length=30, null=True, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Product_type',
        ...
        migrations.AddField(
            model_name='product',
            name='id_promotion',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='coffeeshop.Promotion'),
        ),
        migrations.AddField(
            model_name='product',
            name='id_provider',
