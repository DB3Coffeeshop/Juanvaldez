...
urlpatterns = [
	...
	url(r'^user/clients_points/$', views.h2, name='h2'),
	...
	url(r'^check_sells/$', Sell_value.as_view(), name='check_sells'),
	...
	url(r'^products_list/edit_product/(?P<pk>\d+)$', Product_edit.as_view(), name = 'product_edit'),
	url(r'^user/clients_points_best/$', Client_more_points.as_view(), name = 'best_points_clients'),
	url(r'^user/clients_points_minus/$', Client_minus_points.as_view(), name = 'poor_points_clients'),
]
